...
function setMagnitude(dir, magnitude) {
	return multiplySpeed(normalize(dir), magnitude, magnitude);
}

function multiplySpeed(dir, x, y) {
	dir.x *= x;
	dir.y *= y;
	return dir;
}
