const ACHIEVEMENTS = {
  list: [
    {
      ...
      icon: '👆',
      unlocked: false,
      check: function() { return true; } // Unlocked on first tap
    },
    {
      id: 'reach_level_10',
      ...
      icon: '🎓',
      unlocked: false,
      check: function() { return player.level >= 10; }
    },
    {
      id: 'reach_level_25',
      name: 'Expert Tapper',
      ...
      icon: '🏆',
      unlocked: false,
      check: function() { return player.level >= 25; }
    },
    {
      id: 'reach_level_50',
      name: 'Master Tapper',
      ...
      icon: '👑',
      unlocked: false,
      check: function() { return player.level >= 50; }
    },
    {
      id: 'reach_wave_100',
      name: 'Wave Rider',
      ...
      icon: '🌊',
      unlocked: false,
      check: function() { return gameState.wave >= 100; }
    },
    {
      id: 'collect_1000_red',
      name: 'Red Collector',
      ...
      icon: '🔴',
      unlocked: false,
      check: function() { return player.totalDye && player.totalDye.red >= 1000; }
    },
    {
      ...
      icon: '🔵',
      unlocked: false,
      check: function() { return player.totalDye && player.totalDye.blue >= 1000; }
    },
    {
      ...
      icon: '🟡',
      unlocked: false,
      check: function() { return player.totalDye && player.totalDye.yellow >= 1000; }
    },
    {
      id: 'first_prestige',
      name: 'Reborn',
      ...
      icon: '🌀',
      unlocked: false,
      check: function() { return player.prestigePoints > 0; }
    },
    {
      id: 'collection_25',
      name: 'Collector',
      ...
      icon: '📚',
      unlocked: false,
      check: function() { return COLLECTION.getCompletionPercentage() >= 25; }
    },
    {
      id: 'collection_50',
      name: 'Archivist',
      ...
      icon: '📖',
      unlocked: false,
      check: function() { return COLLECTION.getCompletionPercentage() >= 50; }
    },
    {
      id: 'collection_100',
      name: 'Completionist',
      ...
      icon: '🏅',
      unlocked: false,
      check: function() { return COLLECTION.getCompletionPercentage() >= 100; }
    },
    {
      id: 'max_skill',
      name: 'Skill Master',
  ...
  checkCollection: function() {
    ...
    const collectionAchievements = this.list.filter(a =>
      a.id.startsWith('collection_') && !a.unlocked
    );
      ...
      if (achievement.unlocked) {
        ...
        achievementElement.innerHTML = `
          ...
          <div class="achievement-info">
            ...
            <div class="achievement-description">Achievement locked</div>
          </div>
        `;
      }
